...
const displayOrdersOnPage = (ordersObject) => {
    ...
    ordersObject.forEach((order) => {
        ...
        if (order.selectedPancake === 'Classic') {
            image.src = "/week7/week7_exercise/Pancake_maker_3_final/image/classic-pancake.jpg";
        }
        else if (order.selectedPancake === 'Chocolate') {
            image.src = "/week7/week7_exercise/Pancake_maker_3_final/image/Chocolate-Pancakes.jpg";
        }
        else if (order.selectedPancake === 'Blueberry') {
            image.src = "/week7/week7_exercise/Pancake_maker_3_final/image/pancake-blueberry.jpg";
        }
        image.width = 300;
        image.height = 300;
